...
impl Interactivity {
    ...
    /// Bind the given callback to trackpad pinch (magnify) gesture events during
    /// the bubble phase. The imperative API equivalent to
    /// [`InteractiveElement::on_magnify`]
    ///
    /// See [`Context::listener`](crate::Context::listener) to get access to a view's state from this callback.
    pub fn on_magnify(
        &mut self,
...
pub trait InteractiveElement: Sized {
    ...
    /// Bind the given callback to trackpad pinch (magnify) gesture events,
    /// during the bubble phase. The fluent API equivalent to
    /// [`Interactivity::on_magnify`]
    ///
    /// See [`Context::listener`](crate::Context::listener) to get access to a view's state from this callback.
    fn on_magnify(
        mut self,
